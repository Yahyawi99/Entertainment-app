...
const tvShows = () => {
	...
	const [TvShows, setTvShows] = useState(
		Data.filter((e) => e.category === "TV Series")
	);
	...
	useEffect(() => {
		if (searchValue) {
			...
			// Default option
			setTvShows(Data.filter((e) => e.category === "TV Series"));
		}
	}, [searchValue]);

	return (
		<section className={tvShowsandMovieStyles.moviesContainer}>
			<p className={tvShowsandMovieStyles.title}>TV Series</p>
